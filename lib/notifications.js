...
// `shouldShowAlert` was the old way to say this and is deprecated: a banner
// while the app is open and an entry in the notification list are now asked for
// separately, and both are required. A reminder is worth interrupting for and
// worth keeping around until it's dealt with, so both are on.
