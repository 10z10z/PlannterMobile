...
export async function deletePlant({ plant, detail = null }) {
  ...
  // After the row, and best-effort: a photo left behind costs a megabyte, a
  // plant that can't be pulled because its photo wouldn't delete costs more.
  await deleteImage(plant.image_url);
  return plant.id;
}
