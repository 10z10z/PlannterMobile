...
import { LIGHT_TYPES, SPECTRUMS } from './enums';
import { parseDecimal } from './numbers';

// Defined in ./enums so validation can read them without loading the client.
export { LIGHT_TYPES, SPECTRUMS };
...
export function parseHours(input) {
  const hours = parseDecimal(input);
